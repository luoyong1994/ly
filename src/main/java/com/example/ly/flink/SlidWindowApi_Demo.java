...
public class SlidWindowApi_Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        }).window(SlidingProcessingTimeWindows.of(Time.seconds(10), Time.seconds(5))).reduce(new ReduceFunction<SensorLevelBean>() {
            //5秒中的窗口，划分为一个窗口
            //更详细的聚合控制，可以使用aggregate函数
            @Override
